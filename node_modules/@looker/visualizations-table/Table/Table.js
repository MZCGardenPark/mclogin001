...
export var Table = function Table(_ref) {
  ...
  var formattedData = data.map(function (d) {
    return Object.fromEntries(Object.entries(d).map(function (_ref4) {
      ...
      var valueFormat = isArray(config.series) ? get(config, ['series', matchingMeasureIndex, 'value_format']) : get(config, ['series', key, 'value_format']);
      var valueFormatted = valueFormat ? numeral(value).format(valueFormat) : value;
  ...
  return React.createElement(TableElement, {
    ...
    width: "1px",
    pr: "small"
  }, "Totals"), resultKeys.map(function (key) {
    var val = totals[key];
    return React.createElement(StyledTableDataCell, {
      key: key
    }, val);
...
})(["&:first-child{max-width:0;min-width:0;}padding:", ";"], function (_ref6) {
...
})(["font-size:", ";max-width:500px;overflow-wrap:break-word;position:relative;", "{left:0;padding:", ";position:absolute;top:0;}"], function (_ref8) {
  var theme = _ref8.theme;
  return theme.fontSizes.medium;
}, Truncate, function (_ref9) {
