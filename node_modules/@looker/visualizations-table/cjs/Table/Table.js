...
const Table = ({
  ...
  const formattedData = data.map(d => {
    return Object.fromEntries(Object.entries(d).map(([key, value]) => {
      ...
      const valueFormat = (0, _isArray.default)(config.series) ? (0, _get.default)(config, ['series', matchingMeasureIndex, 'value_format']) : (0, _get.default)(config, ['series', key, 'value_format']);
      const valueFormatted = valueFormat ? (0, _numeral.default)(value).format(valueFormat) : value;
