...
export var Sparkline = function Sparkline(_ref2) {
  ...
  var _data$reduce = data === null || data === void 0 ? void 0 : data.reduce(function (_ref5, d) {
    ...
    dataMax: -Infinity
      ...
      dataSet = _data$reduce.dataSet,
      dataMin = _data$reduce.dataMin,
      dataMax = _data$reduce.dataMax;

  var _ref6 = (config === null || config === void 0 ? void 0 : (_config$y_axis = config.y_axis) === null || _config$y_axis === void 0 ? void 0 : (_config$y_axis$ = _config$y_axis[0]) === null || _config$y_axis$ === void 0 ? void 0 : _config$y_axis$.range) || [],
