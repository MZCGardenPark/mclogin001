...
const Bar = ({
  ...
  const xAxis = _react.default.createElement(_xychart.Axis, {
    ...
    tickComponent: _ref => {
      ...
      return xAxisConfig !== null && xAxisConfig !== void 0 && xAxisConfig.values ? _react.default.createElement(_text.Text, tickProps, formattedValue) : null;
    }
  });
  ...
  const yAxis = _react.default.createElement(_xychart.Axis, {
    ...
    orientation: "left",
    tickComponent: _ref2 => {
      let formattedValue = _ref2.formattedValue,
          tickProps = _objectWithoutProperties(_ref2, _excluded2);

      return yAxisConfig !== null && yAxisConfig !== void 0 && yAxisConfig.values ? _react.default.createElement(_text.Text, tickProps, (0, _utils.formatDateLabel)({
  ...
  return _react.default.createElement(_xychart.DataProvider, {
    ...
    width: width,
    height: height
  }, xAxis, yAxis, _react.default.createElement(_Grid.Grid, {
    config: config
