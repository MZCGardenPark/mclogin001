...
export var PieLegend = function PieLegend(_ref) {
  ...
  var legendOrientation = position === 'top' || position === 'bottom' ? 'horizontal' : 'vertical';
  ...
  var pageSize = legendOrientation === 'horizontal' ? containerWidth * 0.9 : containerHeight * 0.9;
  var totalPages = legendOrientation === 'horizontal' ? Math.floor(contentWidth / Math.max(pageSize, 1)) : Math.floor(contentHeight / Math.max(pageSize, 1));
  ...
  return React.createElement(LegendWrapper, {
    ...
    role: "figure",
    "aria-label": "Legend page ".concat(page + 1, " of ").concat(totalPages + 1)
