...
var VisWrapperInternal = forwardRef(function (props, ref) {
...
var flexDirection = function flexDirection(_ref) {
  ...
  return css(["flex-direction:", ";justify-content:", ";"], positionMap[position], position === 'left' ? 'flex-end' : 'flex-start');
};

export var VisWrapper = styled(VisWrapperInternal).withConfig({
