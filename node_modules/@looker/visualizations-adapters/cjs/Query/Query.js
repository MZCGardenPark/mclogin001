...
const Query = ({
  ...
  const isDataValid = isEveryResponseOk && (data === null || data === void 0 ? void 0 : data.length) && fields && isDataShapeValid;
  (0, _react.useEffect)(() => {
  ...
  const normalizedPivots = pivots ? (0, _utils.normalizePivotLabels)(pivots) : undefined;
  let normalizedData = [];
  ...
  if (isDataValid) {
    normalizedData = normalizedPivots ? (0, _utils.tabularPivotResponse)({
      data,
      fields,
      pivots: normalizedPivots
    }) : (0, _utils.tabularResponse)(data);
    normalizedFields = normalizedPivots ? (0, _utils.buildPivotFields)({
      fields,
      pivots: normalizedPivots
    }) : fields;
  }

  const config = (0, _utils.buildChartConfig)({
    config: (0, _merge.default)({}, visConfig, configProp),
    data: normalizedData,
    fields: normalizedFields
  });
  const dataTransformations = [_dataTransformations.sortByDateTime, _dataTransformations.renderNullValues, _dataTransformations.xAxisReversed];
  ...
  return _react.default.createElement(_QueryContext.QueryContext.Provider, {
    value: {
      ...
      totals: totals ? (0, _utils.formatTotals)(totals) : undefined
    }
  }, children);
};
