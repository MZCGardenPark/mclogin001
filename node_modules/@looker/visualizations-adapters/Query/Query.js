...
import { sortByDateTime, renderNullValues, xAxisReversed } from '../dataTransformations';
import { buildPivotFields, isNumeric, tabularPivotResponse, tabularResponse, normalizePivotLabels, buildChartConfig, formatTotals } from '../utils';
...
export var Query = function Query(_ref) {
  ...
  var isDataValid = isEveryResponseOk && (data === null || data === void 0 ? void 0 : data.length) && fields && isDataShapeValid;
  useEffect(function () {
  ...
  var normalizedPivots = pivots ? normalizePivotLabels(pivots) : undefined;
  var normalizedData = [];
  ...
  if (isDataValid) {
    normalizedData = normalizedPivots ? tabularPivotResponse({
      data: data,
      fields: fields,
      pivots: normalizedPivots
    }) : tabularResponse(data);
    normalizedFields = normalizedPivots ? buildPivotFields({
      fields: fields,
      pivots: normalizedPivots
    }) : fields;
  }
  ...
  var dataTransformations = [sortByDateTime, renderNullValues, xAxisReversed];
