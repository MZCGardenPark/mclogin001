...
function getLookerEmbed() {
   ...
   var url_data = {
       host: 'https://megazonepartner.cloud.looker.com',
       secret: '8c04717c61724e5b5b8dbf412933ffa367ce7be0864159904b9ffedd87ec0c29',
       external_user_id: 'user1',
       permissions: ['see_user_dashboards', 'see_lookml_dashboards', 'access_data', 'see_looks'],
       models: ['crystal_test1'],
       access_filters: {
       },
       session_length: fifteen_minutes,
       embed_url: "/embed/dashboards/82",
